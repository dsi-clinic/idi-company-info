#!/usr/bin/env python3
"""
Unit tests for ftm2j.common.logging
"""
...
from ftm2j.common.logging import get_logger
...
class TestGetLogger:
    ...
    def test_returns_logger_with_expected_name(self):
        ...
        with patch("ftm2j.common.logging._configure_cloudwatch"):
    ...
    def test_calls_configure_cloudwatch(self):
        ...
        with patch("ftm2j.common.logging._configure_cloudwatch") as mock_configure:
...
class TestConfigureCloudwatch:
    ...
    @patch("ftm2j.common.logging._configure_cloudwatch")
    ...
    @patch("ftm2j.common.logging.requests.get")
    @patch("ftm2j.common.logging.watchtower.CloudWatchLogHandler")
    def test_adds_cloudwatch_handler_when_on_ec2(
        ...
        mock_cw_handler_class.assert_called_once_with(log_group="idi-ftm2j-test_logger")
    ...
    def test_no_cloudwatch_handler_when_metadata_fails(self, mock_requests_get):
        ...
        with patch("ftm2j.common.logging.watchtower.CloudWatchLogHandler") as mock_cw:
            logger = get_logger("test_logger")
