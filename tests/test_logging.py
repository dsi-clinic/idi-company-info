#!/usr/bin/env python3
"""
Unit tests for ftm2j.common.logs
"""
...
class TestGetLogger:
    ...
    def test_returns_logger_with_expected_name(self):
        ...
        with patch("ftm2j.common.logs._configure_cloudwatch"):
    ...
    def test_calls_configure_cloudwatch(self):
        ...
        with patch("ftm2j.common.logs._configure_cloudwatch") as mock_configure:
...
class TestConfigureCloudwatch:
    ...
    @patch("ftm2j.common.logs._configure_cloudwatch")
    ...
    @patch("ftm2j.common.logs.requests.get")
    @patch("ftm2j.common.logs.watchtower.CloudWatchLogHandler")
    ...
    def test_no_cloudwatch_handler_when_metadata_fails(self, mock_requests_get):
        ...
        with patch("ftm2j.common.logs.watchtower.CloudWatchLogHandler") as mock_cw:
            logger = get_logger("test_logger")
